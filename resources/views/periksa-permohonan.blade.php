...
<div class="content-section">
    <div class="content-full">
        <p>Untuk memeriksa status permohonan informasi publik yang telah Anda ajukan, silakan masukkan nomor tiket atau nomor registrasi permohonan Anda.</p>
        
        <form class="permohonan-form" method="POST" action="{{ url('/cek-status-permohonan') }}">
            @csrf
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="nomor_tiket">Nomor Tiket Permohonan *</label>
                        <input type="text" id="nomor_tiket" name="nomor_tiket" required placeholder="Masukkan nomor tiket permohonan">
                        <small class="form-help">Contoh: PPID-2024-00123</small>
                    </div>
                    
                    <div class="form-group">
                        <label for="email_pemohon">Email Pemohon *</label>
                        <input type="email" id="email_pemohon" name="email_pemohon" required placeholder="Masukkan email yang digunakan saat mengajukan permohonan">
            ...
            <div class="status-card">
                ...
                <div class="status-content">
                    <div class="status-row">
                        ...
                        <span>PPID-2024-00123</span>
                    </div>
                    <div class="status-row">
                        <strong>Tanggal Pengajuan:</strong>
                        <span>15 Maret 2024, 14:30 WIB</span>
                    </div>
                    <div class="status-row">
                        <strong>Jenis Informasi:</strong>
                        <span>Informasi Statistik Industri Agro</span>
                    </div>
                    <div class="status-row">
        ...
        <div class="info-grid">
            <div class="info-box">
                ...
                <ul>
                    <li><strong>Nomor Tiket:</strong> Diberikan setelah pengajuan permohonan</li>
