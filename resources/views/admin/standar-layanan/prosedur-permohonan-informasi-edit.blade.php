...
@section('title', 'Edit Prosedur Permohonan Informasi - PPID BBIA')
@section('page-title', 'Edit Prosedur Permohonan Informasi')

@section('content')
<div class="content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Edit Prosedur Permohonan Informasi</h1>
        <div>
            <a href="{{ route('admin.prosedur-permohonan-informasi') }}" class="btn btn-secondary">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.prosedur-permohonan-informasi.update', $prosedur->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-between">
                    <div>
                        <form action="{{ route('admin.prosedur-permohonan-informasi.destroy', $prosedur->id) }}" method="POST" style="display: inline-block;">
                            @csrf
                            @method('DELETE')
