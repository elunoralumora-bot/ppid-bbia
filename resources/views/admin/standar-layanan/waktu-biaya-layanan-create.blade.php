...
@section('title', 'Tambah Waktu & Biaya Layanan - PPID BBIA')

@section('content')
<div class="content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Tambah Waktu & Biaya Layanan</h1>
        <div>
    ...
    <div class="form-card">
        <form action="{{ route('admin.waktu-biaya-layanan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="waktu_pelayanan" name="waktu_pelayanan" rows="3" required>{{ old('waktu_pelayanan') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="biaya" name="biaya" rows="3" required>{{ old('biaya') }}</textarea>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="jenis_layanan" name="jenis_layanan">
                            <option value="Permohonan Informasi" {{ old('jenis_layanan') == 'Permohonan Informasi' ? 'selected' : '' }}>Permohonan Informasi</option>
                            <option value="Pengaduan" {{ old('jenis_layanan') == 'Pengaduan' ? 'selected' : '' }}>Pengaduan</option>
                            <option value="Keberatan" {{ old('jenis_layanan') == 'Keberatan' ? 'selected' : '' }}>Keberatan</option>
                            <option value="Sengketa Informasi" {{ old('jenis_layanan') == 'Sengketa Informasi' ? 'selected' : '' }}>Sengketa Informasi</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="tanggal_berlaku" name="tanggal_berlaku" value="{{ old('tanggal_berlaku') }}">
                    </div>
