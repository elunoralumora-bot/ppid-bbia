...
@section('title', 'Tambah Maklumat Informasi Publik - PPID BBIA')
@section('page-title', 'Tambah Maklumat Informasi Publik')

@section('content')
<div class="content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Tambah Maklumat Informasi Publik</h1>
        <div>
    ...
    <div class="form-card">
        <form action="{{ route('admin.maklumat-informasi-publik.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="judul" name="judul" value="{{ old('judul') ?? 'Maklumat Informasi Publik' }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="isi" name="isi" rows="15" required>{{ old('isi') }}</textarea>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="versi" name="versi" value="{{ old('versi') ?? '1.0' }}" placeholder="Contoh: 1.0, 2.0">
                    </div>

                    <div class="mb-3">
                        <label for="tahun_berlaku" class="form-label">Tahun Berlaku</label>
                        <input type="number" class="form-control" id="tahun_berlaku" name="tahun_berlaku" value="{{ old('tahun_berlaku') ?? date('Y') }}" min="2000" max="{{ date('Y') + 5 }}">
                    </div>

                    <div class="mb-3">
                        <label for="file" class="form-label">File Dokumen (PDF) <span class="text-danger">*</span></label>
