...
<div class="content">
    ...
    <div class="form-card">
        <form action="{{ route('admin.informasi-setiap-saat.update', $informasi->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="kategori" name="kategori">
                            <option value="Informasi Setiap Saat" {{ (old('kategori', $informasi->kategori ?? '') == 'Informasi Setiap Saat') ? 'selected' : '' }}>Informasi Setiap Saat</option>
                            <option value="Prosedur Standar" {{ (old('kategori', $informasi->kategori ?? '') == 'Prosedur Standar') ? 'selected' : '' }}>Prosedur Standar</option>
                            <option value="Daftar Informasi" {{ (old('kategori', $informasi->kategori ?? '') == 'Daftar Informasi') ? 'selected' : '' }}>Daftar Informasi</option>
                            <option value="Laporan" {{ (old('kategori', $informasi->kategori ?? '') == 'Laporan') ? 'selected' : '' }}>Laporan</option>
