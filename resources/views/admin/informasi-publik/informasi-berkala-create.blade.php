...
@section('title', 'Tambah Informasi Berkala - PPID BBIA')
@section('page-title', 'Tambah Informasi Berkala')

@section('content')
<div class="content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Tambah Informasi Berkala</h1>
        <div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="kategori" name="kategori">
                            <option value="Informasi Berkala" {{ old('kategori') == 'Informasi Berkala' ? 'selected' : '' }}>Informasi Berkala</option>
                            <option value="Laporan Keuangan" {{ old('kategori') == 'Laporan Keuangan' ? 'selected' : '' }}>Laporan Keuangan</option>
