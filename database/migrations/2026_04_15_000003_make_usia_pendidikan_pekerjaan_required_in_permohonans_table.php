...
return new class extends Migration
{
    public function up()
    {
        ...
        DB::statement("UPDATE permohonans SET usia = 0 WHERE usia IS NULL");
        DB::statement("UPDATE permohonans SET pendidikan_terakhir = '-' WHERE pendidikan_terakhir IS NULL");
        DB::statement("UPDATE permohonans SET pekerjaan = '-' WHERE pekerjaan IS NULL");
